...
namespace TripMaker
{
    public partial class Sub_HotelBookingInfo : UserControl
    {
        ...
        public string HotelName
        {
            ...
            set { hotelName = value; lblName.Text = value; }
        }
        ...
        public string TotalPrice
        {
            ...
            set { totalPrice = value; lblTotalPrice.Text = value; }
        }

        public string Checkin
        {
            get { return checkin; }
            set { checkin = value; lblCheckin.Text = value; }
        }

        public string Checkout
        {
            get { return checkout; }
            set { checkout = value; lblCheckout.Text = value; }
        }

        public string BookingId
        {
            get { return bookingId; }
            set { bookingId = value; lblBookingId.Text = value; }
        }

        public string NightStay
        {
            get { return nightStay; }
            set { nightStay = value; lblNightsStay.Text = value; }
        }
    }
}
